...
{
    public class UpdateLightWeightPerformanceTestCommand
    {
        ...
        public class Handler : IRequestHandler<Request, Response>
        {
            ...
            {                
				var lightWeightPerformanceTest = _eventStore.Load<LightWeightPerformanceTest>(request.LightWeightPerformanceTest.LightWeightPerformanceTestId);
